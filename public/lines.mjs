...
export const LINES = [
  ...
  { id: '7B', color: COLORS.tj7, routes: ['7B'], stops: ['Tegal Mampang', '~CSW', 'Kejaksaan Agung', 'Blok M'] },
  ...
  { id: '9D', color: COLORS.tj9, routes: ['9D'], stops: ['Pasar Minggu', [640, 360], 'Pancoran', 'Tegal Parang', 'Simpang Kuningan'] },
